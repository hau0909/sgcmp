import { handleGetDashboardSubscription } from "@/features/dashboard/controller/dashboard.controller";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const result = await handleGetDashboardSubscription(companyId);
