...
export default function CurrentPlanCard() {
  return (
    <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 relative overflow-hidden flex flex-col justify-between min-h-[220px] shadow-sm hover:border-outline transition-all">
      ...
      <div className="relative z-10 mt-6 pt-4 border-t border-outline-variant/60 flex justify-between items-end">
        ...
        <div className="text-right">
          <p className="text-2xl font-bold text-on-surface">
            500.000 <span className="text-xs font-medium text-on-surface-variant">VNĐ/tháng</span>
          </p>
        </div>
      </div>
    </div>
