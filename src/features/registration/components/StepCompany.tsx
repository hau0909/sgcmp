  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="border-b border-outline-variant/30 pb-4">
        <h3 className="text-lg font-bold text-on-surface">{dict.pages.registration.step_company_title}</h3>
        <p className="text-xs text-on-surface-variant">
          {dict.pages.registration.step_company_desc}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          <label className="block text-sm font-semibold text-on-surface">
            {dict.pages.registration.company_name} <span className="text-error">*</span>
          </label>
          <div className="relative flex items-center">
            <Building className="absolute left-3 w-5 h-5 text-on-surface-variant/70" />
            <input
              type="text"
              placeholder={dict.pages.registration.company_name_placeholder}
        ...
        <div className="space-y-1">
          <label className="block text-sm font-semibold text-on-surface">
            {dict.pages.registration.business_license_no} <span className="text-error">*</span>
          </label>
          <div className="relative flex items-center">
            <Hash className="absolute left-3 w-5 h-5 text-on-surface-variant/70" />
            <input
              type="text"
              placeholder={dict.pages.registration.business_license_placeholder}
        ...
        <div className="space-y-1">
          <label className="block text-sm font-semibold text-on-surface">
            {dict.pages.registration.company_email} <span className="text-error">*</span>
          </label>
          <div className="relative flex items-center">
        ...
        <div className="space-y-1">
          <label className="block text-sm font-semibold text-on-surface">
            {dict.pages.registration.company_phone} <span className="text-error">*</span>
          </label>
          <div className="relative flex items-center">
      ...
      <div className="border-b border-outline-variant/30 pb-4 pt-2">
        <h3 className="text-lg font-bold text-on-surface">{dict.pages.registration.step_address_title}</h3>
        <p className="text-xs text-on-surface-variant">
          {dict.pages.registration.step_address_desc}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-1 relative">
          <label className="block text-sm font-semibold text-on-surface">
            {dict.pages.registration.city} <span className="text-error">*</span>
          </label>
          <div className="relative flex items-center">
            <select
            ...
            >
              <option value="">{dict.pages.registration.city_placeholder}</option>
              {cities.map((city) => (
        ...
        <div className="space-y-1 relative">
          <label className="block text-sm font-semibold text-on-surface">
            {dict.pages.registration.ward} <span className="text-error">*</span>
          </label>
          <div className="relative flex items-center">
            <select
            ...
            >
              <option value="">{dict.pages.registration.ward_placeholder}</option>
              {wards.map((ward) => (
        ...
        <div className="space-y-1">
          <label className="block text-sm font-semibold text-on-surface">
            {dict.pages.registration.street} <span className="text-error">*</span>
          </label>
          <div className="relative flex items-center">
            <input
              type="text"
              placeholder={dict.pages.registration.street_placeholder}
      ...
      <div className="space-y-1">
        <label className="block text-sm font-semibold text-on-surface">
          {dict.pages.registration.description}
        </label>
        <textarea
          rows={3}
          placeholder={dict.pages.registration.description_placeholder}
      ...
      <div className="border-b border-outline-variant/30 pb-4 pt-2">
        <h3 className="text-lg font-bold text-on-surface">{dict.pages.registration.step_docs_title}</h3>
        <p className="text-xs text-on-surface-variant">
          {dict.pages.registration.step_docs_desc}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-1">
          <UploadZone
            label={dict.pages.registration.logo}
            accept="image/*"
            placeholder={dict.pages.registration.logo_placeholder}
        ...
        <div className="space-y-1">
          <UploadZone
            label={dict.pages.registration.license}
            accept="image/*,application/pdf"
            placeholder={dict.pages.registration.license_placeholder}
      ...
      <div className="space-y-2 pt-2">
        <label className="block text-sm font-semibold text-on-surface">
          {dict.pages.registration.gallery}
        </label>
          ...
          {formData.galleryFiles.map((file, idx) => (
            <div key={idx} className="relative aspect-square rounded-xl overflow-hidden border border-outline-variant/60 group bg-surface-container">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-black/40 text-[10px] text-white py-1 text-center font-bold">
                {idx === 0 ? dict.pages.registration.banner : dict.pages.registration.image}
              </div>
            </div>
          ))}
