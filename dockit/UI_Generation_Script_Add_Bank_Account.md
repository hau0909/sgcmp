# UI Generation Script: Add Bank Account Modal

This script provides a highly detailed, component-level UI specification for the **Add Bank Account Dialog Modal** used in the Admin panel.
...
- **Title**: `text-base font-bold text-[#0b1c30] font-headline` (Text: "Thêm tài khoản ngân hàng").
...
- **Placeholder**: "-- Chọn ngân hàng --" (disabled default option).
...
- **Container**: Rendered conditionally above the action buttons.
